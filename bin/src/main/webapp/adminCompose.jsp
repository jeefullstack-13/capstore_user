 ...
 <fieldset style="margin-left: 150px;margin-right: 450px;">
	...
	<form:form class="form-horizontal" role="form"  action="saveEmail" method="post" modelAttribute="emails">
					<div class="form-group">
				    	...
				    	<div class="col-sm-11">
                              <form:input type="email" class="form-control select2-offscreen" path="from_emailId" placeholder="Type from email address" tabindex="-1"/>
				    	</div>
				  	</div>
					<div class="form-group">
				    	<label for="to" class="col-sm-1 control-label">To:</label>
				    	<div class="col-sm-11">
                              <form:input type="email" class="form-control select2-offscreen" path="to_emailId" placeholder="Type to email address" tabindex="-1"/>
				    	</div>
				  	</div>
					<div class="form-group">
				 ...
				 <%--  <form:input class="form-control select2-offscreen"  path="date"  value ="<fmt:formatDate value="${vacancy.date}" pattern="yyyy-MM-dd"/>"/> --%>
